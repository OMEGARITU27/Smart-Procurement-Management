...
public class EmailService {
    ...
    /** Notify user of login or registration activity */
    public void sendSecurityAlert(String toEmail, String action) {
        if (toEmail != null && !toEmail.endsWith("@procurement.com")) {
            String body = "<p>Hello,</p>"
                    + "<p>This is a security notification that your email address was just used to <strong>" + action + "</strong> on the Smart Procurement System.</p>"
                    + "<p>If this was you, no further action is required. If you did not perform this action, please contact support immediately.</p>";
            sendHtmlEmail(toEmail, "Security Alert: Account Activity (" + action + ")", wrapHtml("Security Alert", body));
        }
    }
}
